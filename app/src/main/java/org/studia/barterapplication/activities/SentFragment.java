...
import org.studia.barterapplication.adapters.SentOffersAdapter;
...
/**
 * This is the class of the Sent fragment
 */
public class SentFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        db.collection("offersObj").whereEqualTo("senderId",currentUserId).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                for (QueryDocumentSnapshot documentSnapshots : queryDocumentSnapshots) {
                    offers.add(documentSnapshots.toObject(Offer.class));
                }
                SentOffersAdapter sentOffersAdapter = new SentOffersAdapter(offers, getContext());
                offersRecyclerView.setAdapter(sentOffersAdapter);
            }
        });
