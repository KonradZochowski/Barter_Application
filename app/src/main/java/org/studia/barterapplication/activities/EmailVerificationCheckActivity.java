        ...
        checkBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // otherwise, show an error message.
                    ...
                    Toast.makeText(getApplicationContext(), "Zweryfikuj swój adres e-mail!", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(getApplicationContext(), "Nowy e-mail weryfikacyjny został wysłany.", Toast.LENGTH_SHORT).show();
                        }
                        // otherwise, show an error message.
                        else {
                            Toast.makeText(getApplicationContext(), "Spróbuj ponownie za chwilę.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
